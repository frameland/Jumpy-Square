...
Class VShape Extends VEntity Abstract
	...
	Method CollidesWith:Bool(shape:VShape)
		If VRect(shape)
			Return CollidesWith(VRect(shape))
		ElseIf VCircle(shape)
			Return CollidesWith(VCircle(shape))
		End
		Return False
	End
	
	Method CollidesWith:Bool(with:VRect) Abstract
	Method CollidesWith:Bool(with:VCircle) Abstract
...
'--------------------------------------------------------------------------
	...
	Method Copy:VRect()
		Return New VRect(position.x, position.y, size.x, size.y)
	End
...
'--------------------------------------------------------------------------
	...
	Method CollidesWith:Bool(with:VRect)
		...
		Local helpRect:= New VRect(a1, b1, c1, d1)
	...
	Method CollidesWith:Bool(circle:VCircle)
		...
		Local rotatedCircle:VCircle = circle.Copy()
	...
	Private
	Method New()
		NoDefaultConstructorError("VRect")
	End
	
End


Class VCircle Extends VShape
	...
	Method Copy:VCircle()
		Return New VCircle(position.x, position.y, radius)
	End
...
'--------------------------------------------------------------------------
	...
	Method CollidesWith:Bool(with:VCircle)
	...
	Private
	Method New()
		NoDefaultConstructorError("VCircle")
	End
